...
namespace CollectionsMasterConsoleUI
{
    class Program
    {
        ...
        {
            //print to the console that the number is insider of the list.
            ...
            {
                Console.WriteLine("These isn't the list you are looking for.");
        ...
        {
            //TODO: Create a method to populate the number array with 50 random
            //numbers that are between 0 and 50
